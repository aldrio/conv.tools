// TODO: Remove this file when https://github.com/bmcmahen/sancho/issues/63 is fixed
/** @jsx jsx */
import { jsx } from '@emotion/core'
import * as React from 'react'
import { usePositioner } from 'sancho/src/Hooks/use-positioner'
import { useUid } from 'sancho/src/Hooks/use-uid'
import { safeBind } from 'sancho/src/Hooks/compose-bind'
import { useTheme } from 'sancho/src/Theme/Providers'
import { Text } from 'sancho/src/Text'
import { Touchable } from 'sancho/src/Touchable'
import { useMeasure, Bounds } from 'sancho/src/Hooks/use-measure'
import { Layer } from 'sancho/src/Layer'
import Highlighter from 'react-highlight-words'
import { InputBase } from 'sancho/src/Form'
...
export const ComboBoxOptionText: React.FunctionComponent<ComboBoxOptionTextProps> = ({
  value,
  ...other
}) => {
  const context = React.useContext(ComboBoxContext)
